...
// array to store offline users and online users
    var offliners = [];
    var onliners = [];

    console.log(usernames.length)
// go through username array and for each user,get their stream data and render it
    $.each(usernames, function (index, value) {
        ...
        $.getJSON("https://wind-bow.gomix.me/twitch-api/channels/" + value + "?callback=?", function (x) {
            ...
            var idx = value;
            var ids = "s" + value;
// if data is not available,user empty logo
            if (x.logo == null) {
        ...
        // if stream is null or undefined add class offliners else add onliners class so
...
// show offline,online and all users
